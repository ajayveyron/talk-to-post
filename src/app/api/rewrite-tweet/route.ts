...
export async function POST(request: NextRequest) {
  try {
    ...
    const rewritePrompt = `Please rewrite the following text to fit within ${maxLength} characters, which is the max tweet length for Twitter, while preserving the core message and tone. The rewrite should be engaging and suitable for Twitter.
